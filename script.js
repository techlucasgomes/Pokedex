...
const createCard = (pokemons) => {
    ...
    pokemonHeight.innerHTML = `<strong>Altura:</strong> ${height / 0.1} cm`;
    pokemonWeight.innerHTML = `<strong>Peso:</strong> ${weight / 10} kg`;
    pokemonAbility.innerHTML = `<strong>Habilidades:</strong> ${abilitiesAddSpace}`;
